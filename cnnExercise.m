...
convolvedFeatures = cnnConvolve_1(filterDim, numFilters, convImages, W, b);
...
pooledFeatures = cnnPool_1(poolDim, convolvedFeatures);
...
pooledFeatures = squeeze(cnnPool_1(4, testMatrix));
